...
public class NewscatcherApiClientBuilder {
     ...
     */
    public NewscatcherApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public NewscatcherApiClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public NewscatcherApiClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public NewscatcherApiClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public NewscatcherApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public NewscatcherApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public NewscatcherApiClientBuilder addHeader(String name, String value) {
    ...
    public NewscatcherApiClient build() {
        ...
        return new NewscatcherApiClient(buildClientOptions());
    }
}
