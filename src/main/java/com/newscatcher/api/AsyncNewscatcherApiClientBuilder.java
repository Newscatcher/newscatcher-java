...
import com.newscatcher.api.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncNewscatcherApiClientBuilder {
     ...
     * Sets apiKey
     */
    public AsyncNewscatcherApiClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncNewscatcherApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncNewscatcherApiClientBuilder url(String url) {
     ...
     */
    public AsyncNewscatcherApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncNewscatcherApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncNewscatcherApiClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncNewscatcherApiClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncNewscatcherApiClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncNewscatcherApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncNewscatcherApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncNewscatcherApiClientBuilder addHeader(String name, String value) {
    ...
    protected void setAuthentication(ClientOptions.Builder builder) {
        if (this.apiKey != null) {
            builder.addHeader("x-api-token", this.apiKey);
        }
    }
    ...
    public AsyncNewscatcherApiClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new AsyncNewscatcherApiClient(buildClientOptions());
    }
}
