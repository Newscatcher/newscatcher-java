...
import com.newscatcher.api.resources.aggregationcount.AggregationCountClient;
...
public class NewscatcherApiClient {
    ...
    protected final Supplier<AggregationCountClient> aggregationCountClient;
    ...
    public NewscatcherApiClient(ClientOptions clientOptions) {
        ...
        this.aggregationCountClient = Suppliers.memoize(() -> new AggregationCountClient(clientOptions));
    ...
    public AggregationCountClient aggregationCount() {
