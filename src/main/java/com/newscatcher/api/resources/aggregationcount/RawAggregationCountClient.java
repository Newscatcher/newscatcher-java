...
public class RawAggregationCountClient {
    protected final ClientOptions clientOptions;

    public RawAggregationCountClient(ClientOptions clientOptions) {
     ...
     */
    public NewscatcherApiHttpResponse<GetAggregationCountResponse> get(GetAggregationCountRequest request) {
     ...
     * Retrieves the count of articles aggregated by day or hour based on various search criteria, such as keyword, language, country, and source.
     */
    public NewscatcherApiHttpResponse<GetAggregationCountResponse> get(
        ...
        if (request.getAggregationBy().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "aggregation_by", request.getAggregationBy().get(), false);
        }
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new NewscatcherApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetAggregationCountResponse.class),
                        response);
            }
            try {
     ...
     * Retrieves the count of articles aggregated by day or hour based on various search criteria, such as keyword, language, country, and source.
     */
    public NewscatcherApiHttpResponse<PostAggregationCountResponse> post(PostAggregationCountRequest request) {
     ...
     * Retrieves the count of articles aggregated by day or hour based on various search criteria, such as keyword, language, country, and source.
     */
    public NewscatcherApiHttpResponse<PostAggregationCountResponse> post(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new NewscatcherApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PostAggregationCountResponse.class),
                        response);
            }
            try {
                switch (response.code()) {
