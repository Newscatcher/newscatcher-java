...
public class AsyncRawAggregationCountClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAggregationCountClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<NewscatcherApiHttpResponse<GetAggregationCountResponse>> get(
    ...
    public CompletableFuture<NewscatcherApiHttpResponse<GetAggregationCountResponse>> get(
        ...
        CompletableFuture<NewscatcherApiHttpResponse<GetAggregationCountResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new NewscatcherApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetAggregationCountResponse.class),
                                response));
                        return;
                    }
                    try {
     ...
     * Retrieves the count of articles aggregated by day or hour based on various search criteria, such as keyword, language, country, and source.
     */
    public CompletableFuture<NewscatcherApiHttpResponse<PostAggregationCountResponse>> post(
    ...
    public CompletableFuture<NewscatcherApiHttpResponse<PostAggregationCountResponse>> post(
        ...
        CompletableFuture<NewscatcherApiHttpResponse<PostAggregationCountResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new NewscatcherApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, PostAggregationCountResponse.class),
                                response));
                        return;
                    }
                    try {
