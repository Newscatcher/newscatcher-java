...
@JsonDeserialize(builder = GetSourcesRequest.Builder.class)
public final class GetSourcesRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetSourcesRequest && equalTo((GetSourcesRequest) other);
    }
    ...
    private boolean equalTo(GetSourcesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetSourcesRequest other) {
            lang(other.getLang());
