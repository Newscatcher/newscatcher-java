...
@JsonDeserialize(builder = PostSourcesRequest.Builder.class)
public final class PostSourcesRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PostSourcesRequest && equalTo((PostSourcesRequest) other);
    }
    ...
    private boolean equalTo(PostSourcesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PostSourcesRequest other) {
            lang(other.getLang());
        ...
        public PostSourcesRequest build() {
            return new PostSourcesRequest(
                    lang,
                    countries,
                    predefinedSources,
                    sourceName,
