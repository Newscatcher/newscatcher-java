...
public class RawSearchsimilarClient {
    protected final ClientOptions clientOptions;

    public RawSearchsimilarClient(ClientOptions clientOptions) {
     ...
     */
    public NewscatcherApiHttpResponse<SearchSimilarGetResponse> get(SearchSimilarGetRequest request) {
     ...
     * Searches for articles similar to a specified query.
     */
    public NewscatcherApiHttpResponse<SearchSimilarGetResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new NewscatcherApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), SearchSimilarGetResponse.class),
                        response);
            }
     ...
     */
    public NewscatcherApiHttpResponse<SearchSimilarPostResponse> post(SearchSimilarPostRequest request) {
     ...
     * Searches for articles similar to the specified query. You can filter results by language, country, source, and more.
     */
    public NewscatcherApiHttpResponse<SearchSimilarPostResponse> post(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new NewscatcherApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), SearchSimilarPostResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
