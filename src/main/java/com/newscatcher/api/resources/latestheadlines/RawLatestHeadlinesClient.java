...
public class RawLatestHeadlinesClient {
     ...
     */
    public NewscatcherApiHttpResponse<LatestHeadlinesGetResponse> latestHeadlinesGet() {
        return latestHeadlinesGet(LatestHeadlinesGetRequest.builder().build());
    }

    /**
     * Retrieves the latest headlines for the specified time period. You can filter results by language, country, source, and more.
     */
    public NewscatcherApiHttpResponse<LatestHeadlinesGetResponse> latestHeadlinesGet(RequestOptions requestOptions) {
        return latestHeadlinesGet(LatestHeadlinesGetRequest.builder().build(), requestOptions);
    }
    ...
    public NewscatcherApiHttpResponse<LatestHeadlinesGetResponse> latestHeadlinesGet(
        ...
        return latestHeadlinesGet(request, null);
    }
     ...
     * Retrieves the latest headlines for the specified time period. You can filter results by language, country, source, and more.
     */
    public NewscatcherApiHttpResponse<LatestHeadlinesPostResponse> latestHeadlinesPost() {
        return latestHeadlinesPost(LatestHeadlinesPostRequest.builder().build());
    }

    /**
     * Retrieves the latest headlines for the specified time period. You can filter results by language, country, source, and more.
     */
    public NewscatcherApiHttpResponse<LatestHeadlinesPostResponse> latestHeadlinesPost(RequestOptions requestOptions) {
        return latestHeadlinesPost(LatestHeadlinesPostRequest.builder().build(), requestOptions);
    }
    ...
    public NewscatcherApiHttpResponse<LatestHeadlinesPostResponse> latestHeadlinesPost(
        ...
        return latestHeadlinesPost(request, null);
    }
