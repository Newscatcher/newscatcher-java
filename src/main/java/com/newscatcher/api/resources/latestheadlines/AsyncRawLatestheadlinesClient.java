...
public class AsyncRawLatestheadlinesClient {
     ...
     */
    public CompletableFuture<NewscatcherApiHttpResponse<LatestHeadlinesGetResponse>> get() {
     ...
     * Retrieves the latest headlines for the specified time period. You can filter results by language, country, source, and more.
     */
    public CompletableFuture<NewscatcherApiHttpResponse<LatestHeadlinesPostResponse>> post() {
