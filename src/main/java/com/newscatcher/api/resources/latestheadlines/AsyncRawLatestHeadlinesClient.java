...
public class AsyncRawLatestHeadlinesClient {
    protected final ClientOptions clientOptions;

    public AsyncRawLatestHeadlinesClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<NewscatcherApiHttpResponse<GetLatestHeadlinesResponse>> get() {
    ...
    public CompletableFuture<NewscatcherApiHttpResponse<GetLatestHeadlinesResponse>> get(
        ...
        CompletableFuture<NewscatcherApiHttpResponse<GetLatestHeadlinesResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new NewscatcherApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetLatestHeadlinesResponse.class),
                                response));
                        return;
                    }
                    try {
     ...
     * Retrieves the latest headlines for the specified time period. You can filter results by language, country, source, and more.
     */
    public CompletableFuture<NewscatcherApiHttpResponse<PostLatestHeadlinesResponse>> post() {
    ...
    public CompletableFuture<NewscatcherApiHttpResponse<PostLatestHeadlinesResponse>> post(
        ...
        CompletableFuture<NewscatcherApiHttpResponse<PostLatestHeadlinesResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new NewscatcherApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, PostLatestHeadlinesResponse.class),
                                response));
                        return;
                    }
                    try {
