...
public class AsyncRawLatestHeadlinesClient {
     ...
     */
    public CompletableFuture<NewscatcherApiHttpResponse<LatestHeadlinesGetResponse>> latestHeadlinesGet() {
    ...
    public CompletableFuture<NewscatcherApiHttpResponse<LatestHeadlinesGetResponse>> latestHeadlinesGet(
        ...
        CompletableFuture<NewscatcherApiHttpResponse<LatestHeadlinesGetResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new NewscatcherApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, LatestHeadlinesGetResponse.class),
                                response));
                        return;
                    }
                    try {
     ...
     * Retrieves the latest headlines for the specified time period. You can filter results by language, country, source, and more.
     */
    public CompletableFuture<NewscatcherApiHttpResponse<LatestHeadlinesPostResponse>> latestHeadlinesPost() {
    ...
    public CompletableFuture<NewscatcherApiHttpResponse<LatestHeadlinesPostResponse>> latestHeadlinesPost(
        ...
        CompletableFuture<NewscatcherApiHttpResponse<LatestHeadlinesPostResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new NewscatcherApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, LatestHeadlinesPostResponse.class),
                                response));
                        return;
                    }
                    try {
