...
public final class GetLatestHeadlinesResponse {
    private final Object value;

    private final int type;

    private GetLatestHeadlinesResponse(Object value, int type) {
        this.value = value;
        this.type = type;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetLatestHeadlinesResponse && equalTo((GetLatestHeadlinesResponse) other);
    }

    private boolean equalTo(GetLatestHeadlinesResponse other) {
    ...
    public static GetLatestHeadlinesResponse of(SearchResponseDto value) {
        return new GetLatestHeadlinesResponse(value, 0);
    }

    public static GetLatestHeadlinesResponse of(ClusteredSearchResponseDto value) {
        return new GetLatestHeadlinesResponse(value, 1);
    }
    ...
    static final class Deserializer extends StdDeserializer<GetLatestHeadlinesResponse> {
        Deserializer() {
            super(GetLatestHeadlinesResponse.class);
        }
