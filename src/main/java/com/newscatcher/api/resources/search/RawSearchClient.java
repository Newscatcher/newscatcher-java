...
public class RawSearchClient {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new NewscatcherApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SearchGetResponse.class), response);
            }
            try {
    ...
    public NewscatcherApiHttpResponse<SearchPostResponse> post(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new NewscatcherApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SearchPostResponse.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
