...
public class RawAuthorsClient {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new NewscatcherApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AuthorsGetResponse.class), response);
            }
            try {
    ...
    public NewscatcherApiHttpResponse<AuthorsPostResponse> post(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new NewscatcherApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AuthorsPostResponse.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
