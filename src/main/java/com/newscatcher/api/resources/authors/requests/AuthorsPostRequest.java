...
@JsonDeserialize(builder = AuthorsPostRequest.Builder.class)
public final class AuthorsPostRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AuthorsPostRequest && equalTo((AuthorsPostRequest) other);
    }
    ...
    private boolean equalTo(AuthorsPostRequest other) {
    ...
    public interface AuthorNameStage {
        ...
        Builder from(AuthorsPostRequest other);
    }
    ...
    public static final class Builder implements AuthorNameStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(AuthorsPostRequest other) {
        ...
        @java.lang.Override
        public AuthorsPostRequest build() {
            return new AuthorsPostRequest(
                    authorName,
                    notAuthorName,
                    predefinedSources,
                    sources,
