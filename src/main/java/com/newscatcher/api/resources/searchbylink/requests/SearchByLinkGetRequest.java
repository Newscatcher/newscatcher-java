...
@JsonDeserialize(builder = SearchByLinkGetRequest.Builder.class)
public final class SearchByLinkGetRequest {
    ...
    private SearchByLinkGetRequest(
            Optional<String> ids,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SearchByLinkGetRequest && equalTo((SearchByLinkGetRequest) other);
    }
    ...
    private boolean equalTo(SearchByLinkGetRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SearchByLinkGetRequest other) {
            ids(other.getIds());
        ...
        public SearchByLinkGetRequest build() {
            return new SearchByLinkGetRequest(
