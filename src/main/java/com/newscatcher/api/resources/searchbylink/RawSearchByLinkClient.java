...
public class RawSearchByLinkClient {
    protected final ClientOptions clientOptions;

    public RawSearchByLinkClient(ClientOptions clientOptions) {
     ...
     */
    public NewscatcherApiHttpResponse<SearchResponseDto> searchByLinkGet() {
        return searchByLinkGet(SearchByLinkGetRequest.builder().build());
    }

    /**
     * Searches for articles based on specified links or IDs. You can filter results by date range.
     */
    public NewscatcherApiHttpResponse<SearchResponseDto> searchByLinkGet(RequestOptions requestOptions) {
        return searchByLinkGet(SearchByLinkGetRequest.builder().build(), requestOptions);
    }

    /**
     * Searches for articles based on specified links or IDs. You can filter results by date range.
     */
    public NewscatcherApiHttpResponse<SearchResponseDto> searchByLinkGet(SearchByLinkGetRequest request) {
        return searchByLinkGet(request, null);
    }
     ...
     */
    public NewscatcherApiHttpResponse<SearchResponseDto> searchByLinkPost() {
        return searchByLinkPost(SearchByLinkPostRequest.builder().build());
    }

    /**
     * Searches for articles using their ID(s) or link(s).
     */
    public NewscatcherApiHttpResponse<SearchResponseDto> searchByLinkPost(RequestOptions requestOptions) {
        return searchByLinkPost(SearchByLinkPostRequest.builder().build(), requestOptions);
    }

    /**
     * Searches for articles using their ID(s) or link(s).
     */
    public NewscatcherApiHttpResponse<SearchResponseDto> searchByLinkPost(SearchByLinkPostRequest request) {
        return searchByLinkPost(request, null);
    }
