...
@JsonDeserialize(builder = PostSearchByLinkRequest.Builder.class)
public final class PostSearchByLinkRequest {
    ...
    private PostSearchByLinkRequest(
            Optional<Ids> ids,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PostSearchByLinkRequest && equalTo((PostSearchByLinkRequest) other);
    }
    ...
    private boolean equalTo(PostSearchByLinkRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PostSearchByLinkRequest other) {
            ids(other.getIds());
        ...
        public PostSearchByLinkRequest build() {
            return new PostSearchByLinkRequest(
