...
public class AsyncRawSearchByLinkClient {
    protected final ClientOptions clientOptions;

    public AsyncRawSearchByLinkClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<NewscatcherApiHttpResponse<SearchResponseDto>> get() {
        return get(GetSearchByLinkRequest.builder().build());
    }

    /**
     * Searches for articles based on specified links or IDs. You can filter results by date range.
     */
    public CompletableFuture<NewscatcherApiHttpResponse<SearchResponseDto>> get(RequestOptions requestOptions) {
        return get(GetSearchByLinkRequest.builder().build(), requestOptions);
    }

    /**
     * Searches for articles based on specified links or IDs. You can filter results by date range.
     */
    public CompletableFuture<NewscatcherApiHttpResponse<SearchResponseDto>> get(GetSearchByLinkRequest request) {
     ...
     */
    public CompletableFuture<NewscatcherApiHttpResponse<SearchResponseDto>> get(
            GetSearchByLinkRequest request, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<NewscatcherApiHttpResponse<SearchResponseDto>> post() {
        return post(PostSearchByLinkRequest.builder().build());
    }

    /**
     * Searches for articles using their ID(s) or link(s).
     */
    public CompletableFuture<NewscatcherApiHttpResponse<SearchResponseDto>> post(RequestOptions requestOptions) {
        return post(PostSearchByLinkRequest.builder().build(), requestOptions);
    }

    /**
     * Searches for articles using their ID(s) or link(s).
     */
    public CompletableFuture<NewscatcherApiHttpResponse<SearchResponseDto>> post(PostSearchByLinkRequest request) {
     ...
     */
    public CompletableFuture<NewscatcherApiHttpResponse<SearchResponseDto>> post(
            PostSearchByLinkRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/search_by_link");
        if (requestOptions != null) {
