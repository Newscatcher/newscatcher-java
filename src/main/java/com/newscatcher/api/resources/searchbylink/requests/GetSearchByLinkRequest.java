...
@JsonDeserialize(builder = GetSearchByLinkRequest.Builder.class)
public final class GetSearchByLinkRequest {
    ...
    private GetSearchByLinkRequest(
            Optional<String> ids,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetSearchByLinkRequest && equalTo((GetSearchByLinkRequest) other);
    }
    ...
    private boolean equalTo(GetSearchByLinkRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetSearchByLinkRequest other) {
            ids(other.getIds());
        ...
        public GetSearchByLinkRequest build() {
            return new GetSearchByLinkRequest(
