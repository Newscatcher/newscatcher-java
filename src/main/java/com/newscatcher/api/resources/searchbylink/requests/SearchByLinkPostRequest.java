 ...
 */
package com.newscatcher.api.resources.searchbylink.requests;
...
@JsonDeserialize(builder = SearchByLinkPostRequest.Builder.class)
public final class SearchByLinkPostRequest {
    ...
    private SearchByLinkPostRequest(
            Optional<Ids> ids,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SearchByLinkPostRequest && equalTo((SearchByLinkPostRequest) other);
    }
    ...
    private boolean equalTo(SearchByLinkPostRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SearchByLinkPostRequest other) {
            ids(other.getIds());
        ...
        public SearchByLinkPostRequest build() {
            return new SearchByLinkPostRequest(
