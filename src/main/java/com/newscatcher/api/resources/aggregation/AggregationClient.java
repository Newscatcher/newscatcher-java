...
public class AggregationClient {
    ...
    public AggregationGetResponse get(AggregationGetRequest request, RequestOptions requestOptions) {
        ...
        if (request.getAggregationBy().isPresent()) {
            httpUrl.addQueryParameter(
                    "aggregation_by", request.getAggregationBy().get().toString());
        }
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), AggregationGetResponse.class);
            }
    ...
    public AggregationPostResponse post(AggregationPostRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ResponseBody responseBody = response.body();
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), AggregationPostResponse.class);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
                switch (response.code()) {
