...
public class AsyncRawBreakingNewsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawBreakingNewsClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<NewscatcherApiHttpResponse<BreakingNewsResponseDto>> breakingNewsGet(
        ...
        CompletableFuture<NewscatcherApiHttpResponse<BreakingNewsResponseDto>> future = new CompletableFuture<>();
